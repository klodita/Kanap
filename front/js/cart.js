...
fonction de chaque produit en tenant compte de l'id et la couleur */
    ...
    if (newId == array[0]._id) {
      if (
        refColor == array[0].colors[0] ||
        refColor == array[0].colors[1] ||
        refColor == array[0].colors[2]
      )
    ...
    // Donnée de l'API Kanap Calycé avec Id et ses options couleurs
      ...
      if (
        refColor == array[2].colors[0] ||
        refColor == array[2].colors[1] ||
        refColor == array[2].colors[2]
      )
    ...
    // Donnée de l'API Kanap Eurydomé avec Id et ses options couleurs
      ...
      if (
        refColor == array[4].colors[0] ||
        refColor == array[4].colors[1] ||
        refColor == array[4].colors[2]
      )
    ...
    // Donnée de l'API Kanap Helicé avec Id et ses options couleurs
      ...
      if (
        refColor == array[5].colors[0] ||
        refColor == array[5].colors[1] ||
        refColor == array[5].colors[2]
      )
    ...
    // Donnée de l'API Kanap Thyoné avec Id et ses options couleurs
      ...
      if (
        refColor == array[6].colors[0] ||
        refColor == array[6].colors[1] ||
        refColor == array[6].colors[2]
      )
    ...
    // Donnée de l'API Kanap Orthosie avec Id et ses options couleurs
      ...
      if (
        refColor == array[7].colors[0] ||
        refColor == array[7].colors[1] ||
        refColor == array[7].colors[2] ||
        refColor == array[7].colors[3]
      )
